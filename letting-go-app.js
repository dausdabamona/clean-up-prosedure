...
const guidedScripts = {
  'fondasi': {
    ...
    steps: [
      ...
      { type: 'choice', text: 'Perhatikan emosi apa yang muncul?', options: ['=  Marah', '=" Sedih', '= Kecewa', '=0 Cemas', '=( Takut', '> Lainnya'] },
      { type: 'choice', text: 'Di mana kamu merasakannya di tubuh?', options: ['=ó Dada', '>ƒ Perut', '>‡ Kepala', '=™ Pundak', '>¡ Sesak', 'S Lainnya'] },
      ...
      { type: 'when', text: 'Kapan?' },
      { type: 'completion', text: '<â Selamat!', subtext: 'Kamu telah menyelesaikan satu sesi releasing.' },
  ...
  'wanting-control': {
    ...
    steps: [
      ...
      { type: 'yesno', text: 'Maukah kamu melepaskannya?' },
      { type: 'when', text: 'Kapan?' },
      { type: 'completion', text: '<â Wanting Control Released!', subtext: 'Semakin lepas kontrol, semakin merasa memegang kendali.' },
  ...
  'wanting-approval': {
    ...
    steps: [
      ...
      { type: 'completion', text: '<â Wanting Approval Released!', subtext: 'Sumber cinta sudah ada di dalam diri kamu.' },
      { type: 'insight', text: 'Ada insight?', placeholder: 'Tulis insight...' }
    ]
  },
  ...
  'wanting-security': {
    ...
    steps: [
      ...
      { type: 'yesno', text: 'Maukah kamu melepaskannya?' },
      { type: 'when', text: 'Kapan?' },
      { type: 'completion', text: '<â Wanting Security Released!', subtext: 'Keamanan absolut datangnya dari dalam.' },
      { type: 'insight', text: 'Ada insight?', placeholder: 'Tulis insight...' }
    ]
  },
  ...
  'wanting-separation': {
    ...
    steps: [
      ...
      { type: 'yesno', text: 'Maukah kamu melepaskannya?' },
      { type: 'when', text: 'Kapan?' },
      { type: 'completion', text: '<â Wanting Separation Released!', subtext: 'Kamu sudah pulang ke rumah yang tidak pernah ditinggalkan.' },
      { type: 'insight', text: 'Ada insight?', placeholder: 'Tulis insight...' }
    ]
  },
  ...
  'wanting-all': {
    ...
    steps: [
      ...
      { type: 'completion', text: '<â Semua Wanting Released!', subtext: 'Semakin lepas keinginan, semakin MEMILIKI.' },
      { type: 'insight', text: 'Ada insight?', placeholder: 'Tulis insight...' }
    ]
  },
  ...
  'triple': {
    ...
    steps: [
      ...
      { type: 'choice', text: 'Layer 1: Emosi apa yang muncul?', options: ['=  Marah', '=" Sedih', '=( Takut', '= Kecewa', '=0 Cemas', '> Lainnya'] },
      { type: 'instruction', text: 'Izinkan emosi itu hadir...', subtext: 'Sambut aja.', duration: 4000 },
      { type: 'choice', text: 'Layer 2: Wanting apa yang ada?', options: ['<Æ Control', 'd Approval', '=· Security', '= Separation'] },
      ...
      { type: 'completion', text: '<â Triple Welcoming Selesai!', subtext: 'Kesadaran tidak sama dengan emosi.' },
      { type: 'insight', text: 'Ada insight?', placeholder: 'Tulis insight...' }
    ]
  },
  ...
  'story': {
    ...
    steps: [
      ...
      { type: 'choice', text: 'Ada wanting apa di situ?', options: ['<Æ Control', 'd Approval', '=· Security', '= Separation'] },
      { type: 'instruction', text: 'Izinkan wanting itu hadir...', duration: 4000 },
      ...
      { type: 'completion', text: '<â Cerita Dilepaskan!', subtext: 'Cerita bukan fakta. Cerita tidak terjadi saat ini.' },
      { type: 'insight', text: 'Ada insight?', placeholder: 'Tulis insight...' }
    ]
  },
  ...
  'knowing': {
    ...
    steps: [
      ...
      { type: 'choice', text: 'Ada wanting apa?', options: ['<Æ Control', 'd Approval', '=· Security', '= Separation'] },
      { type: 'instruction', text: 'Izinkan wanting itu hadir...', duration: 4000 },
      ...
      { type: 'completion', text: '<â "Tahu" Dilepaskan!', subtext: 'Semakin sedikit tahu, semakin natural dan bebas.' },
      { type: 'insight', text: 'Ada insight?', placeholder: 'Tulis insight...' }
    ]
  },
  ...
  'quick-basic': {
    ...
    steps: [
      ...
      { type: 'yesno', text: 'Maukah kamu melepaskannya?' },
      { type: 'when', text: 'Kapan?' },
      { type: 'completion', text: '<â Release Selesai!', subtext: 'Sederhana kan?' }
    ]
  },
  ...
  'quick-emergency': {
    ...
    steps: [
      ...
      { type: 'completion', text: '<â Kamu berhasil!', subtext: 'Kamu lebih kuat dari yang kamu pikir.' }
    ]
  }
};
...
function renderStep(index) {
  ...
  switch(step.type) {
    case 'instruction':
      ...
      if (step.subtext) html += '<p class="step-subtext">' + step.subtext + '</p>';
      document.getElementById('btn-next').textContent = 'Lanjut í';
      if (step.duration) {
        setTimeout(function() {
    ...
    case 'input':
      html = '<p class="step-text">' + step.text + '</p>';
      if (step.subtext) html += '<p class="step-subtext">' + step.subtext + '</p>';
      html += '<div class="step-input"><textarea id="step-input" placeholder="' + (step.placeholder || 'Tuliskan...') + '" rows="4"></textarea></div>';
      document.getElementById('btn-next').textContent = 'Lanjut í';
      break;
    ...
    case 'yesno':
      ...
      html += '<button class="answer-btn" onclick="selectAnswer(\'ya\')">Ya</button>';
      html += '<button class="answer-btn" onclick="selectAnswer(\'tidak\')">Tidak</button>';
      html += '</div>';
      html += '<p class="step-subtext" style="margin-top:1rem;">Kedua jawaban valid. Yang penting jujur.</p>';
      document.getElementById('btn-next').textContent = 'Lanjut í';
      break;
    ...
    case 'when':
      html = '<p class="step-text">' + step.text + '</p>';
      html += '<div class="answer-group">';
      html += '<button class="answer-btn highlight" onclick="selectAnswer(\'sekarang\')">< Sekarang</button>';
      html += '<button class="answer-btn" onclick="selectAnswer(\'nanti\')"> Nanti</button>';
      html += '</div>';
      document.getElementById('btn-next').textContent = 'Lanjut í';
      break;
    ...
    case 'breathing':
      html = '<p class="step-text">' + step.text + '</p>';
      if (step.subtext) html += '<p class="step-subtext">' + step.subtext + '</p>';
      html += '<div class="breathing-animation"></div>';
      document.getElementById('btn-next').textContent = 'Lanjut í';
      if (step.duration) {
        setTimeout(function() {
          if (currentSession && currentSession.currentStep === index) {
    ...
    case 'completion':
      html = '<div class="completion-icon">=J</div>';
      html += '<h3 class="completion-title">' + step.text + '</h3>';
      html += '<p class="step-subtext">' + (step.subtext || '') + '</p>';
      document.getElementById('btn-next').textContent = 'Lanjut í';
      stats.releases++;
      saveStats();
      updateStatsDisplay();
    ...
    case 'insight':
      html = '<p class="step-text">' + step.text + '</p>';
      html += '<div class="step-input"><textarea id="insight-input" placeholder="' + (step.placeholder || 'Tulis insight...') + '" rows="3"></textarea></div>';
...
function nextStep() {
  ...
  if (step.type === 'insight') {
    ...
    closeModal();
    showToast('Releasing selesai! <â', 'success');
...
function showReturnBanner() {
  ...
  banner.innerHTML = '<div class="return-banner-content"><span>=Õ Release dari: <strong>Manifesting Workbook</strong></span><span class="return-context">' + (returnContext.content || '') + '</span></div><button onclick="returnToManifesting()" class="btn-return">ê Kembali</button>';
