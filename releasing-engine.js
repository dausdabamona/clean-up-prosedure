...
const ReleasingEngine = (function() {
  ...
  const guidedScripts = {
    'fondasi': {
      ...
      steps: [
        { type: 'instruction', text: 'Stop dulu sebentar...', subtext: 'Rileks dulu.', duration: 6000 },
        { type: 'instruction', text: 'Izinkan saat ini menjadi seperti apa adanya...', subtext: 'Tanpa perlu diubah.', duration: 8000 },
        ...
        { type: 'instruction', text: 'Bisakah kamu hanya memperhatikannya saja?', subtext: 'Jangan dorong, jangan ubah. Perhatikan saja.', duration: 8000 },
        { type: 'instruction', text: 'Bisakah kamu menyambutnya? Mengizinkannya hadir?', subtext: 'Biarkan perasaan itu ada di sini.', duration: 8000 },
        ...
        { type: 'breathing', text: 'Tarik napas dalam... hembuskan...', subtext: 'Biarkan semua terurai...', duration: 10000 },
        { type: 'instruction', text: 'Perhatikan apa yang kamu rasakan sekarang.', subtext: 'Mungkin lebih ringan.', duration: 6000 },
    ...
    'wanting-control': {
      ...
      steps: [
        ...
        { type: 'instruction', text: 'Bisakah kamu menyambut keinginan itu?', subtext: 'Keinginan untuk mengontrol atau dikontrol...', duration: 8000 },
        { type: 'yesno', text: 'Bisakah kamu melepaskan keinginan untuk mengontrol?' },
        { type: 'yesno', text: 'Maukah kamu melepaskannya?' },
        { type: 'when', text: 'Kapan?' },
        { type: 'instruction', text: 'Fokus lagi pada hal yang sama...', subtext: 'Di mana kamu ingin mengontrol...', duration: 6000 },
        { type: 'yesno', text: 'Bisakah kamu melepaskannya?' },
        { type: 'yesno', text: 'Maukah kamu melepaskannya?' },
        { type: 'when', text: 'Kapan?' },
        { type: 'instruction', text: 'Sekali lagi...', duration: 5000 },
    ...
    'wanting-approval': {
      ...
      steps: [
        ...
        { type: 'yesno', text: 'Maukah kamu melepaskannya?' },
        { type: 'when', text: 'Kapan?' },
        { type: 'instruction', text: 'Fokus lagi...', duration: 5000 },
        { type: 'yesno', text: 'Bisakah kamu membebaskannya?' },
        { type: 'yesno', text: 'Maukah kamu melepaskannya?' },
        { type: 'when', text: 'Kapan?' },
        { type: 'instruction', text: 'Perhatikan di mana cinta SUDAH kamu miliki...', subtext: 'Untuk diri sendiri dan orang lain...', duration: 8000 },
        { type: 'instruction', text: 'Izinkan semuanya MELUAS...', duration: 6000 },
        { type: 'completion-check', text: 'Apakah kamu merasa sudah lepas?', subtext: 'Cek di dalam diri kamu.' },
    ...
    'wanting-oneness': {
      ...
      steps: [
        ...
        { type: 'yesno', text: 'Maukah kamu melepaskannya?' },
        { type: 'when', text: 'Kapan?' },
        { type: 'instruction', text: 'Perhatikan bahwa koneksi SUDAH ada...', subtext: 'Tidak perlu dicari di luar.', duration: 8000 },
        { type: 'completion-check', text: 'Apakah kamu merasa sudah lepas?', subtext: 'Cek di dalam diri kamu.' },
    ...
    'wanting-all': {
      ...
      steps: [
        { type: 'instruction', text: 'Stop dulu sebentar...', subtext: 'Rileks.', duration: 6000 },
        { type: 'input', text: 'Pikirkan situasi yang mengganggu...', placeholder: 'Tuliskan situasi...' },
        { type: 'instruction', text: 'Apakah ada keinginan untuk MENGONTROL?', duration: 6000 },
        { type: 'yesno', text: 'Bisakah kamu melepaskan wanting control?' },
        { type: 'when', text: 'Kapan?' },
        { type: 'instruction', text: 'Apakah ada keinginan untuk DICINTAI/DISETUJUI?', duration: 6000 },
        { type: 'yesno', text: 'Bisakah kamu melepaskan wanting approval?' },
        { type: 'when', text: 'Kapan?' },
        { type: 'instruction', text: 'Apakah ada keinginan untuk AMAN/SELAMAT?', duration: 6000 },
        { type: 'yesno', text: 'Bisakah kamu melepaskan wanting security?' },
        { type: 'when', text: 'Kapan?' },
        { type: 'instruction', text: 'Apakah ada keinginan untuk BERPISAH/MENYATU?', duration: 6000 },
        { type: 'yesno', text: 'Bisakah kamu melepaskan wanting separation?' },
        { type: 'when', text: 'Kapan?' },
        { type: 'breathing', text: 'Tarik napas dalam... hembuskan...', duration: 10000 },
        { type: 'completion-check', text: 'Apakah kamu merasa sudah lepas?', subtext: 'Cek di dalam diri kamu.' },
    ...
    'triple': {
      ...
      steps: [
        ...
        { type: 'instruction', text: 'Izinkan emosi itu hadir...', subtext: 'Sambut aja.', duration: 8000 },
        { type: 'choice', text: 'Layer 2: Wanting apa yang ada?', options: ['🎯 Control', '💝 Approval', '🛡️ Security', '🔮 Separation'] },
        { type: 'instruction', text: 'Izinkan wanting itu hadir...', duration: 8000 },
        { type: 'yesno', text: 'Layer 3: Apakah ada RASA KEAKUAN?', subtext: 'Ini tentang KAMU?' },
        { type: 'instruction', text: 'Izinkan rasa keakuan itu hadir...', duration: 8000 },
        { type: 'instruction', text: 'Biarkan ketiganya hadir bersamaan...', subtext: 'Emosi, Wanting, Keakuan.', duration: 10000 },
        { type: 'instruction', text: 'Sekarang, MUNDUR selangkah...', subtext: 'Biarkan terurai sendiri.', duration: 8000 },
        { type: 'yesno', text: 'Bisakah kamu melepaskan semuanya?' },
        { type: 'yesno', text: 'Maukah kamu melepaskannya?' },
        { type: 'when', text: 'Kapan?' },
        { type: 'instruction', text: 'Apakah kamu EMOSI itu, atau yang SADAR akan emosi?', duration: 8000 },
        { type: 'completion-check', text: 'Apakah kamu merasa sudah lepas?', subtext: 'Cek di dalam diri kamu.' },
    ...
    'story': {
      ...
      steps: [
        { type: 'instruction', text: 'Stop dulu sebentar...', duration: 6000 },
        ...
        { type: 'instruction', text: 'Bisakah kamu menyambutnya?', subtext: 'Hadir saja dengan cerita itu.', duration: 8000 },
        ...
        { type: 'when', text: 'Kapan?' },
        { type: 'instruction', text: 'Apakah kamu orang di cerita itu?', subtext: 'Atau hanya ada KEBERADAAN?', duration: 8000 },
        { type: 'completion-check', text: 'Apakah kamu merasa sudah lepas?', subtext: 'Cek di dalam diri kamu.' },
    ...
    'knowing': {
      ...
      steps: [
        ...
        { type: 'instruction', text: 'Bisakah kamu menyambut rasa tahu itu?', duration: 8000 },
        ...
        { type: 'instruction', text: 'Izinkan itu hadir...', duration: 8000 },
        ...
        { type: 'when', text: 'Kapan?' },
        { type: 'instruction', text: 'Bisakah kamu terbuka pada KETIDAKTAHUAN?', subtext: 'Kamu tidak perlu tahu.', duration: 8000 },
        { type: 'instruction', text: 'Apakah ada seseorang yang tahu?', subtext: 'Atau hanya ada INI — keberadaan?', duration: 8000 },
        { type: 'completion-check', text: 'Apakah kamu merasa sudah lepas?', subtext: 'Cek di dalam diri kamu.' },
    ...
    'quick-emergency': {
      ...
      steps: [
        { type: 'breathing', text: 'STOP. Tarik napas dalam...', subtext: 'Hembuskan perlahan...', duration: 8000 },
        { type: 'instruction', text: 'Kamu AMAN saat ini.', subtext: 'Apapun yang terjadi, saat ini kamu aman.', duration: 6000 },
        { type: 'instruction', text: 'Izinkan perasaan ini hadir...', subtext: 'Jangan lawan. Biarkan saja.', duration: 8000 },
        { type: 'yesno', text: 'Bisakah kamu melepaskannya?' },
        { type: 'yesno', text: 'Maukah kamu melepaskannya?' },
        { type: 'when', text: 'Kapan?' },
        { type: 'breathing', text: 'Tarik napas lagi...', duration: 8000 },
        { type: 'yesno', text: 'Bisakah kamu melepaskannya lagi?' },
        { type: 'yesno', text: 'Maukah kamu melepaskannya?' },
        { type: 'when', text: 'Kapan?' },
        { type: 'instruction', text: 'Kamu bukan emosi itu.', subtext: 'Kamu adalah yang SADAR akan emosi.', duration: 8000 },
        { type: 'completion-check', text: 'Apakah kamu merasa sudah lepas?', subtext: 'Cek di dalam diri kamu.' },
    ...
    'goal-release': {
      ...
      steps: [
        ...
        { type: 'yesno', text: 'Maukah kamu melepaskannya?', subtext: 'Mendingan pegangan terus atau bebas?' },
        { type: 'when', text: 'Kapan?' },
        { type: 'breathing', text: 'Tarik napas dalam... hembuskan...', subtext: 'Lepaskan...', duration: 10000 },
        { type: 'instruction', text: 'Apakah kamu itu perasaan ini?', subtext: 'Atau kamu yang MENYADARI perasaan ini?', duration: 8000 },
        { type: 'completion-check', text: 'Apakah kamu merasa sudah lepas?', subtext: 'Cek di dalam diri kamu.' },
  ...
  function doTripleWelcoming(onComplete) {
    const tripleSteps = [
      { text: 'Bisakah kamu menyambut perasaan yang tersisa?', subtext: 'Izinkan hadir sepenuhnya.', duration: 8000 },
      { text: 'Bisakah kamu menyambut wanting yang ada?', subtext: 'Control, approval, atau security?', duration: 8000 },
      { text: 'Bisakah kamu menyambut rasa keakuan?', subtext: 'Ini tentang "kamu"?', duration: 8000 },
      { text: 'Biarkan ketiganya hadir bersamaan...', subtext: 'Emosi, wanting, keakuan. Lalu lepaskan.', duration: 10000 }
    ];
